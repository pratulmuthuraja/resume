...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        \resumeItem{}
          {Designed high-level system architecture and workflow diagrams to define service interactions, data flow, and deployment topology.}
    ...
    \resumeItemListStart
        ...
        \resumeItem{}
          {Designed and implemented event-driven batch jobs for real-time notifications and automated task scheduling, improving engagement and workflow efficiency by 25\%.}
        \resumeItem{}
...
student panel, and events for the Graduate Admissions Office showing 37\% better response rate.}
  ...
  %   \resumeSubheading
		...
		% {Business Development Manager}{June 2018 -  December 2020}\vspace{-5pt}
		% \resumeItemListStart
